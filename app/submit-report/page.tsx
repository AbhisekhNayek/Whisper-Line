        ...
        <div className="mx-auto max-w-3xl">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
              Help us create a safer environment. All reports are encrypted, 
              ensuring your identity remains protected.
            </p>
          </div>

          <div className="mt-16 bg-black/80 rounded-2xl border border-green-500/20 p-6">
            <ReportWizard />
          </div>
        </div>
      </main>
