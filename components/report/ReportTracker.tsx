...
export function ReportTracker() {
  ...
  return (
    <div className="bg-black min-h-screen flex items-center justify-center">
      ...
      <div className="container max-w-2xl p-6 sm:p-8 bg-black rounded-lg shadow-lg border border-green-500/20 w-full">
        {/* Header Section */}
        ...
        <div className="flex flex-col items-center justify-center space-y-8">
          ...
          >
            {/* Form Section */}
            <div
              className={`bg-black/50 backdrop-blur-xl rounded-2xl border border-white/5 p-6 w-full transition-all duration-300
            ...
            >
              ...
              >
                <div className="relative w-full max-w-md mx-auto">
                  <label
                    htmlFor="reportId"
                    className="block text-sm font-medium mb-2 text-green-500/80"
                  >
                    Report ID
                  </label>
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/50 border border-white/5 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-transparent transition-all"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-4 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-xl shadow-lg hover:from-green-400 hover:to-green-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                >
                  {loading ? (
